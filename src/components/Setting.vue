    ...
    export default {
        ...
        methods: {
          switchBtn(){
            const that = this;
            if(that.isOn){
              $(".whiteBtn").css({border:'solid 0.1rem #ccc'});
              $(".cap").animate({left:0},300);
              that.isOn = false;
            }else {
              $(".whiteBtn").css({border:'solid 0.1rem #09a2d6'});
              $(".cap").animate({left:'1.5rem'},300);
              that.isOn = true;
            }
          ...
          CleanUpCaching(){
            ...
            $(".notify-btn-default").css({ borderRadius:0,padding:'0.2rem 1.5rem'});
          },
          goBack(){
            this.$router.go(-1);
          },
