<template>
  <div class="contentMain">
    ...
    <div id="main-top">
      ...
      <router-link to="/GetForce" tag="div" class="option4">
        <div class="option4-Icon"><span class="glyphicon glyphicon-stats"></span></div>
        获取原力
      </router-link>
      <router-link to="/GetBlackDrill" tag="div" class="option4">
        <div class="option4-Icon"><span class="glyphicon glyphicon-gift"></span></div>
        黑钻活动
      </router-link>
      <router-link to="/Introduce" tag="div" class="option4" id="information">
        <div class="option4-Icon option5-Icon"><span class="glyphicon glyphicon-credit-card"></span></div>
        资讯挖钻
      </router-link>
      <div id="imgDiv"></div>
    </div>
...
<style>
  ...
  .option3{
    right: 0;
    top: 80px;
    border-top: #196EA8 solid 1.5px;
    border-bottom: #196EA8 solid 1.5px;
    border-left: #196EA8 solid 1px;
    border-right:none;
