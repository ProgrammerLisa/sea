var App = {};
			...
			App.setup = function() {
				...
				this.armsPop = 1;   //触须的数量
				this.particlesPerArm = 15;   //小圈的调节
				...
				// Some forces
				this.gravity = -2;     //重力
				this.springStiffness = 0.5;  //弹性
				this.viscosity = 0.1;					//粘性
				this.isElastic = false;				//约束 必须为false
			};
			...
			App.evolve = function() {
				this.stepCount++;
				this.target.radius = 50 + 30 * Math.sin(this.stepCount / 10); //数字1:头部半径; 数字2:水母粗度
			};
			App.move = function() {
